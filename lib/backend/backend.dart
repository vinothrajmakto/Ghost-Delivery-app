...
import 'schema/blacklisted_record.dart';
...
export 'schema/blacklisted_record.dart';
...
/// Functions to query BlacklistedRecords (as a Stream and as a Future).
Future<int> queryBlacklistedRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BlacklistedRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BlacklistedRecord>> queryBlacklistedRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BlacklistedRecord.collection,
      BlacklistedRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BlacklistedRecord>> queryBlacklistedRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
